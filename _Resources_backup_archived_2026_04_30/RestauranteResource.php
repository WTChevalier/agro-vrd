...
class RestauranteResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\Tabs::make('Restaurante')
                    ->tabs([
                        // ==========================================
                        ...
                        // ==========================================
                        Forms\Components\Tabs\Tab::make('Plan')
                            ...
                            ->schema([
                                Forms\Components\Section::make('Plan Actual')
                                    ->schema([
                                        ...
                                        Forms\Components\Placeholder::make('suscripcion_info')
                        ...
                        // ==========================================
                        Forms\Components\Tabs\Tab::make('Confianza')
                            ...
                            ->schema([
                                Forms\Components\Section::make('Nivel de Confianza (Interno)')
                                ...
                                Forms\Components\Section::make('Factores de Confianza')
                                    ->schema([
                                        Forms\Components\Placeholder::make('factores_info')
                        ...
                        // ==========================================
                        Forms\Components\Tabs\Tab::make('Certificación')
                            ...
                            ->schema([
                                Forms\Components\Section::make('Certificación Pública')
                        ...
                        // TAB: VERIFICACIÓN
                        // ==========================================
                        Forms\Components\Tabs\Tab::make('Verificación')
                                ...
                                Forms\Components\Section::make('Estado de Verificación')
                                    ->schema([
                                        ...
                                        Forms\Components\Select::make('verificado_por')
                                            ...
                                            ->options(Personal::activos()->verificadores()->pluck('nombre_completo', 'id'))
                                            ->searchable(),
                        ...
                        Forms\Components\Tabs\Tab::make('Configuración')
                            ...
                            ->schema([
                                Forms\Components\Section::make('Opciones de Servicio')
                                    ->schema([
                                ...
                                Forms\Components\Section::make('Funciones Personalizadas')
                        ...
                        // TAB: FISCAL
                        // ==========================================
                        Forms\Components\Tabs\Tab::make('Fiscal')
                        ...
                        Forms\Components\Tabs\Tab::make('Estado')
                            ...
                            ->schema([
                                Forms\Components\Section::make('Estado del Restaurante')
                                    ->schema([
        ...
        return $table
            ...
            ->actions([
                Tables\Actions\ActionGroup::make([
                    ...
                    Tables\Actions\Action::make('recalcular_confianza')
                        ->label('Recalcular Confianza')
                        ->icon('heroicon-o-calculator')
                        ->requiresConfirmation()
                        ->action(fn ($record) => $record->actualizarNivelConfianza()),
                    Tables\Actions\Action::make('generar_qr')
                        ->label('Generar QR')
