    ...
    public static function form(Schema $schema): Schema
    {
        return $schema
            ->schema([
                ...
                Schemas\Components\Section::make('Contacto')
                    ->schema([
                ...
                Schemas\Components\Section::make('Rol y Permisos')
                    ->schema([
                ...
                Schemas\Components\Section::make('Zonas Asignadas')
                    ->schema([
                ...
                Schemas\Components\Section::make('Horario de Trabajo')
                    ->schema([
                ...
                Schemas\Components\Section::make('Fechas y Estado')
                    ->schema([
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('tareas_pendientes_count')
                    ...
                    ->counts([
// DISABLED:                         'tareasAsignadas' => fn (Builder $query) => $query->whereIn('estado', ['pendiente', 'en_progreso']),
                    ])
                    ->sortable(),
