...
class CuponResource extends Resource
{
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema
            ->schema([
                Schemas\Components\Section::make('Información del Cupón')
                    ->schema([
                ...
                Schemas\Components\Section::make('Tipo de Descuento')
                    ->schema([
                ...
                Schemas\Components\Section::make('Límites de Uso')
                    ->schema([
                ...
                Schemas\Components\Section::make('Vigencia')
                    ->schema([
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->actions([
                ...
                \Filament\Actions\Action::make('copiar')
                    ->label('Copiar Código')
