...
class CertificacionResource extends Resource
{
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema
            ->schema([
                Schemas\Components\Section::make('Información de la Certificación')
                    ->schema([
                ...
                Schemas\Components\Section::make('Puntuación Requerida')
                    ->schema([
                ...
                Schemas\Components\Section::make('Criterios de Evaluación')
                ...
                Schemas\Components\Section::make('Beneficios')
                    ->schema([
