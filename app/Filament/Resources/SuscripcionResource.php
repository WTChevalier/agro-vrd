...
class SuscripcionResource extends Resource
{
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema
            ->schema([
                Schemas\Components\Section::make('Información de la Suscripción')
                    ->schema([
                ...
                Schemas\Components\Section::make('Período')
                    ->schema([
                ...
                Schemas\Components\Section::make('Descuentos y Ajustes')
                    ->schema([
                ...
                Schemas\Components\Section::make('Motivo de Cancelación')
                    ->schema([
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->actions([
                \Filament\Actions\Action::make('renovar')
                    ->label('Renovar')
                ...
                \Filament\Actions\Action::make('suspender')
                    ->label('Suspender')
