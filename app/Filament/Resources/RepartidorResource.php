    ...
    public static function form(Schema $schema): Schema
    {
        return $schema
            ->schema([
                ...
                Schemas\Components\Section::make('Vehículo')
                    ->schema([
                ...
                Schemas\Components\Section::make('Licencia')
                    ->schema([
                ...
                Schemas\Components\Section::make('Zona de Trabajo')
                    ->schema([
                ...
                Schemas\Components\Section::make('Estadísticas')
                    ->schema([
